...
function submit_editar() {
    ...
    $.ajax({
        ...
        type: "GET",
        url: "/Catalogo/edit_skid_Json",
        data: { 'id': id, 'nombre': nombre, 'descripcion': descripcion, 'codigo': codigo,'habilitado': habilitado },
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (response) {
            if (response != null) {
...
function submit_agregar() {
    ...
    $.ajax({
        ...
        type: "GET",
        url: "/Catalogo/add_skid_Json",
        data: { 'nombre': nombre, 'descripcion': descripcion, 'codigo': codigo, 'habilitado': habilitado },
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (response) {
            if (response != null) {
